...
**Version:** v1.0.14 (released — caption export fix for full-source editor exports)  
...
- **v1.0.14 (released)** — Fix caption export regression when exporting full-source editor recordings without trim
